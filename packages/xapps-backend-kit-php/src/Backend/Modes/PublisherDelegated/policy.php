...
function xapps_backend_kit_publisher_delegated_policy_reference_details(): array
{
    return [
...
function xapps_backend_kit_publisher_delegated_resolve_policy_request(array $payload, array $app): array
{
    $input = xapps_backend_kit_build_payment_policy_input(
        $payload,
        $app,
        xapps_backend_kit_publisher_delegated_payment_mode_metadata(),
    );
